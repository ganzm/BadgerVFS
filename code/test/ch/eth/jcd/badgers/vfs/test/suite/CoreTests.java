...
import ch.eth.jcd.badgers.vfs.test.core.DirectoryManipulationTest;
import ch.eth.jcd.badgers.vfs.test.core.FileManipulationTest;
...
@RunWith(Suite.class)
@SuiteClasses({ BadgersVFSDiskManagerTest.class, BadgersVFSEntryTest.class, BadgersVFSPathTest.class, HashTest.class, DirectoryManipulationTest.class,
		FileManipulationTest.class })
