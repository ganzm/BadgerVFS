...
public class EntryTreeCellRenderer extends DefaultTreeCellRenderer {
	...
	private static final Logger LOGGER = Logger
			.getLogger(EntryTreeCellRenderer.class);
	...
	static {
		try {
			folderClosed = ResourceLocator
					.getResourceAsIcon("images/Folder-icon.png");
			folderOpen = ResourceLocator
					.getResourceAsIcon("images/Folder-Open-icon.png");
		} catch (IOException e) {
	...
	public Component getTreeCellRendererComponent(JTree tree, Object value,
			boolean bSelected, boolean bExpanded, boolean bLeaf, int iRow,
			boolean bHasFocus) {
		 ...
		 * 
		 * if (selected) { entryPanel.setBackground(backgroundSelectionColor);
		 * entryPanel.setForeground(textSelectionColor); } else {
